...
/**
 * Simple momentary button connected to a digital pin 2
 * uses interrupt routine to get information about button press.
...
class MyPinButton : public Pin2Button
{
public:
  MyPinButton() : Pin2Button()
  {
  }
